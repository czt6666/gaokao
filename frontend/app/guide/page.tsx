...
const FAQ: { q: string; a: string }[] = [
  ...
  { q: "查不到结果怎么办？", a: "先检查筛选条件是不是太严苛：① 批次别只勾了「专科」——查本科要选「本科批」，否则会把本科专业全部过滤掉，结果自然为空；② 专业门类、城市、层次、性质等限定越多，结果越少，可先放宽或清空再查。条件确认无误仍为空，可能是该位次/分数段在该省份确无匹配院校，建议扩大位次范围或切换省份。" },
    ...
    <div style={{ minHeight: "100vh", background: "var(--color-bg)" }}>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "32px 20px 80px" }}>
        ...
        <Section id="start" title="二、3 步上手">
          ...
          <Tip>本科分数请选本科批，不要去筛专科的专业，否则会把能报的本科全部过滤掉、结果为空。城市 / 层次 / 性质等限定越多，结果越少，建议先放宽再逐步收紧。</Tip>
